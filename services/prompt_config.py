...
DEFAULT_PROMPTS: dict[str, str] = {
    ...
    "bidding_scarf_enrichment": "Du bist ein neurowissenschaftlicher KI-Analyst für das originale SCARF-Modell (David Rock, 2008). Analysiere Mitarbeiterkommentare des Unternehmens '{company_name}' streng nach den 5 originalen Dimensionen: 1. Status (Wertschätzung/Ansehen), 2. Certainty (Sicherheit/Vorhersehbarkeit), 3. Autonomy (Autonomie/Handlungsspielraum), 4. Relatedness (Zugehörigkeit/Vertrauen), 5. Fairness (Gerechtigkeit/Transparenz). Berechne für jeden Kommentar Scores von 0 (starke Bedrohung/Threat) bis 100 (starke Belohnung/Reward) Punkten. Bestimme primäre Bedrohungs- (primary_threat) und Belohnungssignale (primary_reward) und antworte als strukturiertes JSON.",
}
