...
async def test_extract_company_summary_success():
    ...
    async def mock_post(*args, **kwargs):
        return MockResponse(
            {"status": "success", "data": {"summary": "Great financial performance.", "is_sufficient_data": True}}
        )
...
async def test_extract_company_summary_insufficient_data():
    ...
    async def mock_post(*args, **kwargs):
        return MockResponse({"status": "success", "data": {"summary": "Not enough info.", "is_sufficient_data": False}})
