...
from api.v1 import bids, checklist, comments, documents, internal  # noqa: E402

for r in (internal.router, bids.router, checklist.router, documents.router, comments.router):
